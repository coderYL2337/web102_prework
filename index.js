...
function addGamesToPage(games) {
    ...
    for (const game of games) {
        ...
        gameCard.innerHTML = `<div class="game-card">
...
// Update the contributionsCard element's content
...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${numfundedGames} game${numfundedGames > 1 ? 's' : ''}. Currently, ${numUnfundedGames} game${numUnfundedGames > 1 ? 's' : ''} remain${numUnfundedGames > 1 ? '' : 's'} unfunded. We need your help to fund these amazing games!`;
